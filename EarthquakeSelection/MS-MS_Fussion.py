...
MS_Seq_path= r'C:\Users\vacalder\Documents\TimeDependent_PBEE\EarthquakeSelection\Sequences\Mainshock-Mainshock'
...
#        plt.plot(t2_new,A2_new)
        ...
        with open(MS_Seq_path+'\\'+x+y+'.g3', 'w') as f:
            for item in MS_MS:
                f.write("%s\n" % item)