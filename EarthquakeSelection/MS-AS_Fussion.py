...
MS_path= r'C:\Users\vacalder\Documents\TimeDependent_PBEE\EarthquakeSelection\Mainshocks'
AS_path= r'C:\Users\vacalder\Documents\TimeDependent_PBEE\EarthquakeSelection\Aftershocks'
Seq_path= r'C:\Users\vacalder\Documents\TimeDependent_PBEE\EarthquakeSelection\Sequences'
...
for x in MainshockFiles:
    for y in AftershockFiles:
        ...
        t2_new = np.linspace(dt1+TF1,TF2+TF1,NPT2new)
